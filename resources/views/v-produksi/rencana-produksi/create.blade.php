                    ...
                    <div class="d-flex flex-wrap gap-3">
                        ...
                        <div class="flex-grow-1">
                            <div class="mb-3">
                                ...
                                <select class="form-control" name="form_po_id" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="datetime-local" class="form-control @error('mulai_produksi') is-invalid @enderror"
                                    name="mulai_produksi" value="{{ old('mulai_produksi') }}" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="datetime-local" class="form-control @error('berakhir_produksi') is-invalid @enderror"
                        ...
                        <div class="flex-grow-1">
                            <div class="mb-3">
                                ...
                                <select class="form-control @error('status') is-invalid @enderror" name="status" required>
                                    ...
                                    <option value="produksi" {{ old('status') == 'produksi' ? 'selected' : '' }}>Produksi</option>
