                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" name="tanggal_barang_masuk" id="tanggal_barang_masuk"
                                    ...
                                    value="{{ old('tanggal_barang_masuk', date('Y-m-d')) }}"required />
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('stok_id') is-invalid @enderror" name="stok_id"
                                    ...
                                    @foreach ($barangMasuk as $sb)
                                        <option value="{{ $sb->id_stok }}"
                                            {{ old('stok_id') == $sb->id_stok ? 'selected' : '' }}>
                                            {{ $sb->nama_produk }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="jumlah_barang_masuk" id="jumlah_barang_masuk"
                                    ...
                                    value="{{ old('jumlah_barang_masuk') }}" min="1" required />
