...
<header class="navbar navbar-expand-md d-print-none">
    {{-- header atas --}}
    <div class="container-xl mx-2 my-1">
        ...
        <div class="d-flex justify-content-end gap-3 align-items-center">
            <form action="{{ route('logout') }}" method="post">
                @csrf
                <button type="submit" class="btn btn-danger border border-1 rounded-2 focus-ring focus-ring-danger " href="">
                    Logout
                </button>
            </form>
            ...
            <div class="navbar-nav flex-row order-md-last">
                ...
                <div class="nav-item">
                    <div class="nav-link d-flex lh-1 text-reset p-0">
                        ...
                        <div class="d-none d-xl-block ps-2">
                            <div>Halo Dhafa!</div>
                            <div class="mt-1 small text-secondary">Produksi</div>
                        </div>
                    </div>
                </div>
            </div>
